...
function callCard(props) {
  ...
  return (
    <div className="flex-none mb-6 relative flex lg:flex-col h-[150px] lg:h-[632px] bg-[#2c2c2c]  border-[2px] border-[#3866F266] shadow-md hover:shadow-xl w-[365.82px] rounded-lg lg:rounded-2xl ">
      <img
        src={eventImg}
      ...
      <div className="font-dm-sans flex-[2] flex items-center flex-col w-full">
        <div className="text-white w-10/12 h-fit mt-4 items-center  mx-auto">
          <h1 className="font-[900] text-center lg:text-left text-xl lg:text-3xl leading-tight">
            {eventName}
          </h1>
          <p className=" font-[300] hidden lg:block lg:text-lg">
            {eventDescription}
          </p>
        </div>

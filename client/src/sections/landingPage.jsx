  ...
  return (
    <div className="relative w-full bg- flex flex-col pb-12">
      ...
      <div className="font-dm-sans flex flex-col self-center items-center sm:items-start md:w-9/12 pt-24 pb-20 md:py-28">
        <h className="font-bold text-5xl md:text-7xl lg:text-8xl bg-gradient-to-b from-[#097ED8] to-[#000000] bg-clip-text text-transparent pb-4">
          IEDC SUMMIT
        </h>
        <h className="font-bold text-4xl md:text-6xl lg:text-7xl bg-gradient-to-b from-[#2B394366] to-[#000000] bg-clip-text text-transparent pb-16">
          2023
        </h>
